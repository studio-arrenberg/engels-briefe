          ...
          <div className="toc toc_back">
            ...
            <section className="writing-session" id="index.xml-body.1_div.2">
              ...
              >
                ...
                <div className="dateline"><span style={{display: 'inline-block'}} width="6cm">&nbsp;</span><span className="placeName">Hagen</span> <span className="date">5 <span className="g.enc.tagsdecl.suspension.type3"> (Jan.)</span><span className="expan">Jan<span className="ex">uar</span></span></span></div>
                  </div>
                  <div className="opener"><span style={{display: 'inline-block'}} width="3cm">&nbsp;</span><a id="teaser.part.001.s">
                      {/*anchor*/}</a>
                    <div id="testj" className="salute">Liebﬅe beﬅe <span className="abbr"> (F<span className="g.enc.tagsdecl.cc.abbr-colon-sup"><sup>in</sup><span className="orig">⹀</span><span className="corr">.</span></span>)</span><span className="expan">F<span className="ex">reund</span>in</span></div><a id="teaser.part.001.e">
                      {/*anchor*/}</a>
                  </div>
