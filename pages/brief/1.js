              ...
              <section className="writing-session" id="index.xml-body.1_div.2">
                ...
                >
                  ...
                  <p>
                    ...
                    <span className="corr">daß</span> Du mir ſchon ſo bald
                    ...
                    gabﬅ, so kurz dein Brief auch war, so machte er
                  ...
                  <p>
                    <span className="religion">
                      ...
                      Jahr wünſche ich dir meine Liebe!{" "}
                      ...
                      <span className="corr">den</span> beﬅen{" "}
                      <span className="g.enc.tagsdecl.suspension.type1">
                        {" "}
                        (Seg.)
                      </span>
                      ...
                      <span className="corr">innern</span> Menſchen,
                      <br className="lb" /> vorzüglich wünſche ich: Daß{" "}
                      ...
                      <span className="expan">
                        J<span className="ex">eſu</span>
                      </span>
                      <br className="lb" /> Chriﬅi{" "}
                      <span className="g.enc.tagsdecl.suspension.type1">
                        {" "}
                        (empfang)
                      </span>
                      ...
                      <br className="lb" /> ſehr, und gebe dir{" "}
                      <span className="g.enc.tagsdecl.suspension.type1">
                        {" "}
                        (dageg)
                      </span>
                      ...
                      Liebe
                      <br className="lb" /> und{" "}
                      <span className="orig">Freündſchaft</span>
                      <span className="corr">Freundſchaft</span>;{" "}
                    ...
                    <span className="corr">Freundin</span>, war das verfloſſne
                    ...
                    mir mit ſo <span className="orig">auſerordentlich</span>
                    ...
                    <span className="orig">groſen</span>
                    <span className="corr">großen</span>, mir ſchon{" "}
                    ...
                    <span className="expan">
                      umſchwebend<span className="ex">en</span>
                    </span>
                    ...
                    <span className="g.enc.tagsdecl.suspension.type1">
                      {" "}
                      (<span className="orig">Wichtigﬅ</span>
                      <span className="corr">wichtigﬅ</span>)
                    </span>
                    <span className="expan">
                      <span className="orig">Wichtigﬅ</span>
                      <span className="corr">wichtigﬅ</span>
                    ...
                    des Chriﬅenthums, wodurch der Schaden für mich ſo groß
                    <br className="lb" /> und unausbleiblich geweſen wäre;{" "}
                    <a id="teaser.part.002.s">{/*anchor*/}</a>
                    <span className="orig">Die</span>
                    <span className="corr">die</span> Erfahrung ſo ich{" "}
                    ...
                    gemacht habe,
                    <br className="lb" /> hat mir unbeſchreiblich wohl gethan,
                    ...
                    <br className="lb" /> für die Zukunft ſehr geﬅärkt, ſo{" "}
                    <span className="orig">Daß</span>
                    ...
                    mein ganzes <span className="orig">Schikſal</span>
                    <span className="corr">Schickſal</span> in den{" "}
                    <span className="g.enc.tagsdecl.suspension.type1">
                      {" "}
                      (Händ)
                    </span>
                    ...
                    <a id="teaser.part.002.e">{/*anchor*/}</a> in der feﬅen
                    Zuverſicht, daß er{" "}
                    <span style={{ textDecoration: "underline" }}>mich</span> ſo
                    <br className="lb" />{" "}
                    <span style={{ textDecoration: "underline" }}>
                      führen wird
                    </span>{" "}
                    ...
                    <span style={{ textDecoration: "underline" }}>beﬅe</span>,{" "}
                    ...
                    iﬅ, welches auch <span className="orig">jezt</span>
                    <span className="corr">jetzt</span> beﬅändig
                    <br className="lb" /> der{" "}
                    <span style={{ textDecoration: "underline" }}>
                    ...
                    <span className="overwritten">iﬅ</span>
                    ...
                    werden,{" "}
                    <span style={{ textDecoration: "underline" }}>nun</span>, ſo{" "}
                    <a id="txt.hi.underline002.int.s">{/*anchor*/}</a>ge
                    <span style={{ textDecoration: "underline" }}>
                      ſchehe ſein Heiliger Wille!
                    </span>
                    ...
                    <span style={{ textDecoration: "underline" }}>
                      <span className="orig">beﬅen</span>
                      <span className="corr">Beﬅen</span>
                    </span>{" "}
                    <span className="g.enc.tagsdecl.suspension.type1">
                      {" "}
                      (trag)
                ...
                >
                  <p>
                    ...
                    <br className="lb" /> <span className="orig">muﬅe</span>
                    ...
                    meine
                    <br className="lb" /> Schweﬅer war beim{" "}
                    <span className="g.enc.tagsdecl.suspension.type1">
                      {" "}
                      (vorig)
                    </span>
                    ...
                    auch so viel <span className="orig">ﬅärke</span>
                    ...
                    <span className="orig">wiederﬅand</span>
                    <span className="corr">widerﬅand</span> und das Tanzen mit{" "}
                    ...
                    <span className="orig">Das</span>
                    <span className="corr">das</span>{" "}
                    <span className="orig">kanﬅ</span>
                    <span className="corr">kannﬅ</span>{" "}
                    <span className="orig">du</span>
                    <span className="corr">Du</span> Dir meine{" "}
                    <span className="orig">beﬅe</span>
                    <span className="corr">Beﬅe</span>! wohl
                    <br className="lb" />{" "}
                    <span className="orig">Vorﬅellen</span>
                    <span className="corr">vorﬅellen</span>,{" "}
                    <span className="orig">Die</span>
                    ...
                    Stolz nicht die <span className="orig">angenemﬅe</span>
                    <span className="corr">angenehmﬅe</span>, doch aber
                    <br className="lb" /> für{" "}
                    <span className="g.enc.tagsdecl.suspension.type1">
                      {" "}
                      (selbig)
                  ...
                  <p>
                    ...
                    <span className="corr">freute</span> mich ſehr
                  ...
                  <blockquote className="closer">
                    <p>
                      ...
                      Jacobi empfiehl ich mich aufs Herzlichﬅe
                      <span className="orig" />
                      <span className="corr">.</span>
                    </p>
                  </blockquote>
