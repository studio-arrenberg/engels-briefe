                ...
                >
                  ...
                  <p>
                    ...
                    <span className="liebe-ehe active">
                      ...
                      der Geſinnungen, und der Familie
                      <br className="lb" /> der{" "}
                      ...
                      entſprechen:<a id="teaser.part.002.e">{/*anchor*/}</a>
                    </span>{" "}
                    Ihr natürlicher{" "}
                    ...
                    <br className="lb" /> an ihr bemerkt; etwas zu ſagen, das
                    ...
                    auf ihren Sinn eigenwillig zu beﬅehen, ſcheint ihr
                    <br className="lb" /> gar nicht eigen, ſondern
                    Nachgiebigkeit, und leichte Lenkſamkeit ein
                    ...
                    <span className="corr">Meinung</span> von ſich ſelbﬅ, und
                    irrt ſich <span className="orig">darinn</span>
                    ...
                    daran denkt, wie ſie ſich andern
                    <br className="lb" /> gefällig machen, und ihnen zur Freude
                    ſeÿn möge; — <a id="mark.001.s">{/*anchor*/}</a>
                    <span className="religion active">
                      Was ihre Geſinnungen
                      <br className="lb" />{" "}
                      ...
                      <br className="lb" /> und nicht nur oberflächig, ſondern
                      feﬅ und tief gegründet iﬅ; Es iﬅ ihr
                      <br className="lb" /> ernﬅlich um ihre Selbﬅbeſſerung zu
                      thun, und ſie hat würklich{" "}
                ...
                >
                  <p>
                    <span className="religion active">
                      ...
                      ihre innre
                      <br className="lb" /> Ruhe mehr werth iﬅ, als alle Luﬅ
                      dieſer Welt, und alle{" "}
                      ...
                      <br className="lb" /> ſeit einigen Jahren nahm ſie an
                    ...
                    <span className="corr">Person</span>, deren ſie Urſache
                    hätte, ſich zu ſchämen.
                    <br className="lb" /> ſie hat, ſoviel ich weiß, 3 Brüder und
                    2 Schweﬅern; der ältere Bruder <br className="lb" /> iﬅ
                    ...
                    und ehrenvolle Bedienungen; ſeine Frau iﬅ eine{" "}
                    <span className="g.rend.script.latin">Mauritz</span> von{" "}
                    <span className="placeName">Weſel</span>,
                    <br className="lb" /> Der{" "}
                    <span className="orig">
                      Zwe
                      <span className="orig">
                  ...
                  <p className="enc.tagsdecl.indent-medium">
                    ...
                    ſchätzen, der ſie zur Gattin bekömmt.
