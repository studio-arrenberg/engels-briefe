            ...
            <section className="writing-session" id="index.xml-body.1_div.2">
              ...
              >
                ...
                <p>
                  ...
                  <a id="teaser.part.002.s">{/*anchor*/}</a>Ihrer Bitte, daß ich
                  Ihnen eine
                  ...
                  entſprechen:<a id="teaser.part.002.e">{/*anchor*/}</a> Ihr
                  natürlicher{" "}
                  ...
                  ſeÿn möge; — <a id="mark.001.s">{/*anchor*/}</a>Was ihre
                  Geſinnungen
              ...
              style={{
                ...
                <p>
                  ...
                  <a id="mark.001.e">{/*anchor*/}</a> Was zuletzt ihre{" "}
